...
| [台灣電子發票統一 SDK](examples/einvoice-n8n/) | TypeScript SDK（[`MorrisLu-Taipei/einvoice`](https://github.com/MorrisLu-Taipei/einvoice)，5 家供應商）→ 80 行 Hono wrapper svc + 6 個治理 workflow | **v0.28.0 hardened**：svc `tsc` 0 err · `npm audit` 0 CVE · `/healthz` 200 · 13 個 SEC-### finding 見 [`SECURITY-REVIEW.md`](examples/einvoice-n8n/SECURITY-REVIEW.md)（9 修、4 追蹤）· scanner 0 err / 3 expected warn · REST import 6/6 · **end-to-end runtime smoke 排 v0.29**（不再做假「驗證通過」宣稱） |
